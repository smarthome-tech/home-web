      ...
      <div className="footer-content">
          ...
          <div className="footer-links">
            ...
            <div className="footer-column">
              ...
              <div className="footer-social">
                <a href="https://www.facebook.com/share/18Jd7JF2ow/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" className="footer-link">Facebook</a>
              </div>
            </div>
          </div>
        </div>
        <div className="footer-bottom">
          ...
          <div className="footer-legal">
            <p className="footer-copyright">© 2025 SmartHome. Created by <span className="footer-creator">Apollo Creations</span></p>
          </div>
        </div>
      </div>
    </footer>
